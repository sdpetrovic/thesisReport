...
x_{n}\left(t+h\right)=\displaystyle\sum_{k=0}^{K}\dfrac{x_{n}^{\left(k\right)}\left(t\right)}{k!}\left(h\right)^{k} \quad + \quad	T_{n,K}
\end{equation}
