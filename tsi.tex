...
\nomenclature[Ra6]{$x_{n}$}{n$^{th}$ state variable \nomunit{-}}
\nomenclature[Ra2]{$T_{n,k}$}{Truncation error \nomunit{-}}
\nomenclature[Ra7]{$K$}{Maximum order \nomunit{-}}
\nomenclature[Ra7]{$k$}{Order derivative \nomunit{-}}
...
\nomenclature[Ra7]{$x_{n}$}{Auxiliary equation \nomunit{-}}
\nomenclature[Ra7]{$u_{n}$}{Auxiliary derivative \nomunit{-}}
\nomenclature[Ra7]{$w_{n,i}$}{Auxiliary function \nomunit{-}}
\nomenclature[Ra7]{$f_{n}$}{Auxiliary placeholder function \nomunit{-}}
\nomenclature[Ra7]{$g_{n}$}{Auxiliary placeholder function \nomunit{-}}
...
\nomenclature[Ra7]{$X$}{Taylor Series coefficient (also $X_{n}$) \nomunit{-}}
...
\nomenclature[Ra7]{$f$}{Limit function \nomunit{-}}
...
\nomenclature[Ga7]{$\alpha$}{Root finding curve coefficient \nomunit{-}}
...
\nomenclature[Ra7]{$\textbf{r}$}{Radius vector \nomunit{-}}
\nomenclature[Ra7]{$\textbf{V}$}{Velocity vector \nomunit{-}}
...
\nomenclature[Ra7]{$a_{g}$}{Gravitational acceleration \nomunit{km/s$^{2}$}}
\nomenclature[Ra7]{$a_{D}$}{Drag acceleration \nomunit{km/s$^{2}$}}
\nomenclature[Ra7]{$a_{T}$}{Thrust acceleration \nomunit{km/s$^{2}$}}
...
\nomenclature[Ra7]{$C$}{Transformation matrix coefficient \nomunit{-}}
...
\nomenclature[Ra7]{$\mathbf{\hat{i}}$}{Unit vector in x-direction \nomunit{-}}
\nomenclature[Ra7]{$\mathbf{\hat{j}}$}{Unit vector in y-direction \nomunit{-}}
\nomenclature[Ra7]{$\mathbf{\hat{h}}$}{Unit vector in z-direction \nomunit{-}}
