...
\nomenclature[Ra7]{$k$}{Runge-Kutta increment derivative \nomunit{-}}
...
\nomenclature[Ra7]{$a_{i,j}$}{\ac{RKF} coefficients of the previous time-derivatives \nomunit{-}}
\nomenclature[Ra7]{$b_{i}$}{\ac{RKF} weights for each point  \nomunit{-}}
\nomenclature[Ra7]{$c_{i}$}{\ac{RKF} step-size weights \nomunit{-}}
\nomenclature[Ra7]{$n$}{Order \nomunit{-}}
\nomenclature[Ra7]{$x$}{State variable \nomunit{-}}
