...
\acro{DOPRIN87}[DOPRIN8(7)]{Dormand-Prince 8$^{th}$ $\left(7^{th}\right)$ order}
...
\acro{RKF45}[RKF4(5)]{Runge-Kutta-Fehlberg 4$^{th}$ $\left(5^{th}\right)$ order}
\acro{RKF56}[RKF5(6)]{Runge-Kutta-Fehlberg 5$^{th}$ $\left(6^{th}\right)$ order}
\acro{RKF78}[RKF7(8)]{Runge-Kutta-Fehlberg 7$^{th}$ $\left(8^{th}\right)$ order}
