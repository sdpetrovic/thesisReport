...
\nomenclature[Ra7]{$V$}{Velocity \nomunit{km/s}}
\nomenclature[Ra7]{$m_{MAV}$}{\ac{MAV} mass \nomunit{kg}}
...
\nomenclature[Ga7]{$\omega_{P}$}{Off-set angle between inertial frame and zero meridian at inertial frame set time \nomunit{rad}}
\nomenclature[Ga7]{$\chi$}{Heading angle (or azimuth) \nomunit{rad}}
\nomenclature[Ga7]{$\gamma$}{Flight-path angle \nomunit{rad}}
\nomenclature[Ga7]{$\tau$}{Rotational longitude \nomunit{rad}}
\nomenclature[Ga7]{$\psi_{T}$}{Thrust azimuth angle \nomunit{rad}}
\nomenclature[Ga7]{$\epsilon$}{Thrust elevation angle \nomunit{rad}}
...
\nomenclature[Ga7]{$\rho$}{Density \nomunit{kg/km$^{3}$}}
\nomenclature[Ca7]{$S$}{Reference area \nomunit{9.1$\cdot$10$^{-8}$ km$^{2}$}}
\nomenclature[Ra7]{$C_{D}$}{Drag coefficient \nomunit{-}}
...
\nomenclature[Ca7]{$R_{MOLA}$}{Mars \acs{MOLA} reference radius \nomunit{3396 km}}
\nomenclature[Ra7]{$h$}{Altitude \nomunit{km}}
...
\nomenclature[Ra7]{$M$}{Mach number \nomunit{-}}
\nomenclature[Ra7]{$a$}{Speed of sound \nomunit{km/s}}
...
\nomenclature[Ra7]{$T_{a}$}{Temperature \nomunit{K}}
\nomenclature[Ra7]{$R_{a}^{*}$}{Specific gas constant \nomunit{km$^{s}$ s$^{2}$ K$^{-1}$}}
\nomenclature[Ra7]{$p_{n}$}{Polynomial coefficient \nomunit{-}}
...
\nomenclature[Ra7]{$\Delta V$}{Change in velocity \nomunit{km/s}}
...
\nomenclature[Ra7]{$a$}{Semi-major axis \nomunit{km}}
...
\nomenclature[Ra7]{$m_{prop}$}{Propellant mass \nomunit{kg}}
%
