...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.8 \textwidth]{figures/heritage/biPropellantSSTOMAV_vaughan2016technology-And-hybridSSTOMAV_karp2016technology.jpg}
...
All the coordinate transformations can be found in \Cref{app:appendixAA-referenceSystemTransformations}, which include both position and velocity vectors. These transformations are essential in defining the models and setting up the equations of motion.
