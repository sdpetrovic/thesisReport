...
\nomenclature[Ra7]{$\mathbb{T}$}{Transformation matrix \nomunit{-}}
...
\nomenclature[Ra7]{$\phi$}{General Euler angle \nomunit{rad}}
...
\nomenclature[Ra7]{$x$}{x-position coordinate \nomunit{km}}
\nomenclature[Ra7]{$y$}{y-position coordinate \nomunit{km}}
\nomenclature[Ra7]{$z$}{z-position coordinate \nomunit{km}}
\nomenclature[Ra7]{$r$}{Radius \nomunit{km}}
\nomenclature[Ga7]{$\delta$}{Latitude \nomunit{rad}}
\nomenclature[Ga7]{$\lambda$}{Inertial longitude \nomunit{rad}}
